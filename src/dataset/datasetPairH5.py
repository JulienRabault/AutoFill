...
class PairHDF5Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Data processing
        data_q_saxs = self.transformer_q_saxs.fit_transform(data_q_saxs)
        data_y_saxs = self.transformer_y_saxs.fit_transform(data_y_saxs)
        data_q_les = self.transformer_q_les.fit_transform(data_q_les)
        data_y_les = self.transformer_y_les.fit_transform(data_y_les)
