...
class CustomizableVAE(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, down_channels=[32, 64, 128], up_channels=[128, 64, 32], down_rate=[2, 2, 2], up_rate=[2, 2, 2], cross_attention_dim=16, strat="y"):
